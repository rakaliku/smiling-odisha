      ...
      <div className="container relative py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-background/70">
            <li className="flex items-start gap-2"><MapPin className="h-4 w-4 mt-0.5 text-primary-glow" /> Bhubaneswar, Odisha</li>
            <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-primary-glow" /> hello@smilingodisha.org</li>
            <li className="flex items-center gap-2"><Phone className="h-4 w-4 text-primary-glow" /> +91 98765 43210</li>
          </ul>
        </div>
      </div>
