  ...
  return (
    ...
    >
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="font-display text-2xl">Share a Moment</DialogTitle>
          <DialogDescription>
            Add a photo from your social work activities. Stored locally on your device.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Health camp at Koraput"
              className="mt-1.5"
            />
          </div>
